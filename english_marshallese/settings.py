...
SECRET_KEY = 'django-insecure-1&10@%9^8vyn+#ds4m+l51^(9f!)g@j7a&nu7c$jpwdtj!(h+5'
...
ROOT_URLCONF = 'english_marshallese.urls'
...
WSGI_APPLICATION = 'english_marshallese.wsgi.application'
